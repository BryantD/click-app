...
Run `cookiecutter gh:BryantD/click-app` and then answer the prompts. Here's an example run:

    $ cookiecutter gh:BryantD/click-app
    app_name []: click app template demo
    description []: Demonstrating https://github.com/BryantD/click-app
    hyphenated [click-app-template-demo]: 
    underscored [click_app_template_demo]: 
    github_username []: BryantD
    author_name []: Bryant Durrell
